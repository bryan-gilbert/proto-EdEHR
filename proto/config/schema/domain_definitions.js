...
const person = {
  ...
  gender: {
    type: TYPES.select, label: "Gender",
    options: [
...
const vitalSign = {
  ...
  temperatureSource: {
    type: TYPES.select, label: "Temperature Source",
    options: [
...
ehr_schema.patientHistory = {
    ...
    psychosocial: {
      ...
      behaviors: {
        type: TYPES.checklist, label: "Behaviors",
        options: [
          {
            exercise: {type: TYPES.select, label: "Exercise",
              options: [
          ...
          , {
            caffeine: {type: TYPES.select, label: "Caffeine",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
          ...
          , {
            tobacco: {type: TYPES.select, label: "Tobacco",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
            },
            frequency: {type: TYPES.select, label: "Tobacco use",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
            },
            externalRef: {type: TYPES.url, label: "Reference"}
          }
          , {
            cannabis: {type: TYPES.select, label: "Cannabis",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
          ...
          , {
            alcohol: {type: TYPES.select, label: "Alcohol",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
          ...
          , {
            substanceUse: {type: TYPES.select, label: "Substance Use",
              options: [
                {label: 'Yes', value: 'true'},
                {label: 'No', value: 'false'},
                {label: 'Yes or No', value: '', default:true}]
