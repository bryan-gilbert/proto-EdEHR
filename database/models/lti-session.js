...
const LtiSessionSchema = new Schema({
  user_id: {
    type: String,
    required: true
  },
  ...
  consumer_guid: {type: String},
  consumer_key: {type: String},
  lti_data: {type: String},
  date: {
    type: Date,
    default: Date.now
  }
...
const LtiSession = mongoose.model('ltiSession', LtiSessionSchema)
